defmodule RumblWeb.VideoControllerTest do
  ...
  test "lists all user's videos on index", %{conn: conn, user: user} do
    user_video = insert_video(user, %{title: "funny cats", description: "Some video", url: "http://www.youtube.com"})
    other_video = insert_video(insert_user(%{username: "other"}), %{title: "another video", description: "Some video", url: "http://www.youtube.com"})
  ...
  @tag login_as: "max"
  test "does not create video and redirects error when invalid", %{conn: conn} do
